...
export function LoadingScreen({ text }: LoadingScreenProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-[#003DA5] to-[#0055CC]">
      <div className="text-center text-white">
        {/* Quebec flag */}
        <svg className="mx-auto mb-4 h-20 w-28 animate-bounce rounded-md shadow-lg" viewBox="0 0 9600 6400" xmlns="http://www.w3.org/2000/svg">
          <path fill="#fff" d="M0 0h9600v6400H0z"/>
          <g id="lb">
            <path fill="#003da5" d="M4000 0v2400H0V0zM2309 1622v-129h-115c0-66 32-130 66-150 20-17 65-25 104-5 51 29 54 113 28 151 243-45 219-280 136-365-67-69-140-79-196-58-128 46-214 199-218 427h-67c0-207 36-273 130-534 48-123 19-275-65-415-31-50-69-95-112-144-43 49-81 94-112 144-84 140-113 292-65 415 94 261 130 327 130 534h-67c-4-228-90-381-218-427-56-21-129-11-196 58-83 85-107 320 136 365-26-38-23-122 28-151 39-20 84-12 104 5 34 20 66 84 66 150h-115v129h239c-3 67-39 119-106 148 8 28 49 85 105 81 11 60 21 94 71 149 50-55 60-89 71-149 56 4 97-53 105-81-67-29-103-81-106-148z" id="la"/>
            <use xlinkHref="#la" x="5600"/>
          </g>
          <use xlinkHref="#lb" y="4000"/>
        </svg>
        <h2 className="mb-2 text-3xl font-bold">Essence QC</h2>
        <p className="mb-6 text-sm opacity-85">{text}</p>
        <div className="mx-auto h-8 w-8 animate-spin rounded-full border-3 border-white/30 border-t-white" />
      </div>
    </div>
  );
}
